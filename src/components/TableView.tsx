...
import { rowsToCSV, shareOrDownloadCSV } from '../lib/export'
  ...
  return (
    <div className="card">
      <div className="row" style={{justifyContent:'space-between'}}>
        ...
        <div className="row">
          <button className="ghost" onClick={exportCSV}>Export / Share CSV</button>
      ...
      <div style={{overflowX:'auto'}}>
        <table className="table">
          <thead>
            <tr>
              <th>Scanned at</th><th>Code</th><th>Street</th><th>City</th><th>State</th><th>ZIP</th><th>Conf(code)</th><th>Conf(addr)</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
            {rows.map(r => (
